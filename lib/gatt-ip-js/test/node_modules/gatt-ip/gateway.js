...
function Gateway(gattip, scanFilters) {
    ...
    // REQUESTS =================================================
    this._authenticate = function (callback, token) {
        // TODO: Hack
        var params = {};
        params['access_token'] = token;
        params['authenticate']  = 'authenticate';
        console.warn('HACK ALERT: Sending authenticate');
        gattip.request('authenticate', params, callback, function (params) {
    ...
    this.centralState = function (callback, pwrAlert, centralID) {
        var params = {};
